...
namespace PJ
{
    ...
    public struct ViewPosition : SomePosition
    {
        ...
        public static implicit operator Vector2(ViewPosition position) => new(position.Position.X, position.Position.Y);
    ...
    public struct ScreenPosition : SomePosition
    {
        ...
        public static implicit operator Vector2(ScreenPosition position) => new(position.Position.X, position.Position.Y);

...
namespace PJ
{
    namespace Graph
    {
        ...
        {
            protected GoStandardNode node;

            public SerialBuilder(GoStandardNode node)
            {
                this.node = node;
            }
            ...
            public SerialBuilder OutputTo(string outputIdentifier, GoStandardNode toNode, string inputIdentifier)
            {

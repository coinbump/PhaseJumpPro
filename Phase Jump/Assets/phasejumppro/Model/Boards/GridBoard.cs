...
//typedef PJ_GridTile Tile;
//	typedef PJ_TStdVector<PJ_BoardGridPtr>  GridVector;
//typedef PJ_TRetainSet<Tile> TileSet;

//protected:
//	static PJ_Vector2Int sGridNeighborAxialLocs[];

//int mDepth; // Cached, for faster queries vs mGrids.size()

//friend class PJ_GridTile;

//virtual void evtAddTile(Tile* tile)
//{
//	mBroadcaster->BroadcastParam(kEvtAddTile, tile);
//}
//virtual void evtRemoveTile(Tile* tile)
//{
//	mBroadcaster->BroadcastParam(kEvtRemoveTile, tile);
//}
...
//virtual void evtTileModified(Tile* tile) { }    // To synch data changes.

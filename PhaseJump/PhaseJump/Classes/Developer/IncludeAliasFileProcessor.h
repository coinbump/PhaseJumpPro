...
namespace PJ_Dev {
    /**
     Scans for .h files and creates an "alias" .h file with a link to the .h file in the project directory
     Needed because PhaseJump .h files are hierarchical, but IDEs like Visual Studio don't support recursive includes

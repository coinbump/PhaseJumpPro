...
/**
    ...
    WIN32: far, near are reserved in Visual Studio. Use zNear/zFar for portability.

    https://www.scratchapixel.com/lessons/3d-basic-rendering/perspective-and-orthographic-projection-matrix/orthographic-projection-matrix.html

 */
void Matrix4x4::LoadOrthographic(float left, float right, float bottom, float top, float zNear, float zFar)
{
...
Matrix4x4 Matrix4x4::operator*(const Matrix4x4& rhs) const
{
    ...
    result[0]  = (*this)[0] * rhs[0]  + (*this)[4] * rhs[1]  + (*this)[8] * rhs[2]   + (*this)[12] * rhs[3];
    result[1]  = (*this)[1] * rhs[0]  + (*this)[5] * rhs[1]  + (*this)[9] * rhs[2]   + (*this)[13] * rhs[3];
    result[2]  = (*this)[2] * rhs[0]  + (*this)[6] * rhs[1]  + (*this)[10] * rhs[2]  + (*this)[14] * rhs[3];
    result[3]  = (*this)[3] * rhs[0]  + (*this)[7] * rhs[1]  + (*this)[11] * rhs[2]  + (*this)[15] * rhs[3];

    result[4]  = (*this)[0] * rhs[4]  + (*this)[4] * rhs[5]  + (*this)[8] * rhs[6]   + (*this)[12] * rhs[7];
    result[5]  = (*this)[1] * rhs[4]  + (*this)[5] * rhs[5]  + (*this)[9] * rhs[6]   + (*this)[13] * rhs[7];
    result[6]  = (*this)[2] * rhs[4]  + (*this)[6] * rhs[5]  + (*this)[10] * rhs[6]  + (*this)[14] * rhs[7];
    result[7]  = (*this)[3] * rhs[4]  + (*this)[7] * rhs[5]  + (*this)[11] * rhs[6]  + (*this)[15] * rhs[7];

    result[8]  = (*this)[0] * rhs[8]  + (*this)[4] * rhs[9]  + (*this)[8] * rhs[10]  + (*this)[12] * rhs[11];
    result[9]  = (*this)[1] * rhs[8]  + (*this)[5] * rhs[9]  + (*this)[9] * rhs[10]  + (*this)[13] * rhs[11];
    result[10] = (*this)[2] * rhs[8]  + (*this)[6] * rhs[9]  + (*this)[10] * rhs[10] + (*this)[14] * rhs[11];
    result[11] = (*this)[3] * rhs[8]  + (*this)[7] * rhs[9]  + (*this)[11] * rhs[10] + (*this)[15] * rhs[11];

    result[12] = (*this)[0] * rhs[12] + (*this)[4] * rhs[13] + (*this)[8] * rhs[14]  + (*this)[12] * rhs[15];
    result[13] = (*this)[1] * rhs[12] + (*this)[5] * rhs[13] + (*this)[9] * rhs[14]  + (*this)[13] * rhs[15];
    result[14] = (*this)[2] * rhs[12] + (*this)[6] * rhs[13] + (*this)[10] * rhs[14] + (*this)[14] * rhs[15];
    result[15] = (*this)[3] * rhs[12] + (*this)[7] * rhs[13] + (*this)[11] * rhs[14] + (*this)[15] * rhs[15];

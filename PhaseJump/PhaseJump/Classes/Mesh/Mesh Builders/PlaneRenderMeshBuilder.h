#ifndef PJPLANERENDERMESHBUILDER_H
#define PJPLANERENDERMESHBUILDER_H
...
namespace PJ {
    ...
    class PlaneRenderMeshBuilder : public SomeRenderMeshBuilder
    {
    public:
        ...
        PlaneRenderMeshBuilder() {
        }

        PlaneRenderMeshBuilder(Vector2 worldSize = Vector2::one, Vector2Int meshSize = Vector2Int::three, Axis faceAxis = Axis::Z)
        {

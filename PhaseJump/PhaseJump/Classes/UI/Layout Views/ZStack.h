...
namespace PJ
{
    ...
    protected:
        void _ApplyLayout(Vector2 layoutSize) override
        {
            ...
            auto preferredStackHeight = preferredStackHeightOptional ? preferredStackHeightOptional.value() : layoutSize.y;
            ...
            for (auto view : childViews)
            {
                ...
                auto childWidth = childPreferredWidth ? childPreferredWidth.value() : preferredStackWidth;
                auto childHeight = childPreferredHeight ? childPreferredHeight.value() : preferredStackHeight;

...
namespace PJ {
    ...
    template <class T>
    class AnimatedEffect : public WorldComponent<> {
        Animator<T> animator;
        Valve valve;
    };
...
//    /// animations
//    class ValveEffect : public WorldComponent<> {
//    public:
...
//            valve->turnOffTimer =
//                MAKE<TransformTimer>(turnOffTime, RunType::RunOnce,
//                MAKE<OutSquaredEase>());
//            valve->turnOnTimer =
//                MAKE<TransformTimer>(turnOnTime, RunType::RunOnce,
//                MAKE<OutSquaredEase>());
//        }
//
//        void Awake() override {

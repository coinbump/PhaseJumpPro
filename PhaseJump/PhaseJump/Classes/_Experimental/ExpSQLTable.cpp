...
//  PhaseJumpTests
//
//  Created by Jeremy Vineyard on 3/30/23.
//

//#include <stdio.h>

//void SQLTable::addBuildTableStr(String& params, bool& gotOne, String& name, String& sqlType, String& paramStr)
//{
//    if (gotOne) {
//        params.append(", ");
//    }
...
//                    }
//                    addBuildTableStr(params, gotOne, colName, sqlType, paramStr);
//
//                    // Add default after primary key.
//                    PJ_TagPtr    defaultTag;
//                    if (child->GetTag(SQL_DEFAULT_PNAME, defaultTag)) {
//                        String defaultStr = GetTagSQLDefault(defaultTag.get());
//                        paramStr.append(" ");
...
//                if (child->GetTag(PJ::TagNames::Type, typeTag)) {
//
//                    result = result && db->AddColumn(name, child->name, GetTagSQLType(typeTag.get()));
//                }
//            }
//        }
//    }
...
//}
//
//void SQLTable::WriteStatementBlob(sqlite3_stmt* statement, int colIndex, String& path, bool writeEmpty) {
//
...
//
//// TODO: untested
//void SQLTable::CollectAllRows(PJ_TStdVector<PJ_FragmentPtr>& rows, DataType blobType) {
...
//                        float    floatVal = static_cast<float>(sqlite3_column_double(statement, i));
//                        row->SetFloatValue(colName, floatVal);
//                        break;
//                    }
//                    case SQLITE_TEXT: {
//                        String    strVal((const char*)sqlite3_column_text(statement, i));
...
//                                String    blobPath = fm->TempFilesPath("phasejump_blob");
//                                WriteStatementBlob(statement, i, blobPath, true);
//
//                                // Parse blob.
...
//                                PJLog("UNSUPPORTED. Can't convert data blogs to fragments yet.");
//                                break;
//                            default:
//                                break;
//                        }
...
//
//int SQLTable::CachedIntValue(String& colName, String& whereColumn, String& whereMatch, int defaultValue) {
//    if (NULL == db) { return defaultValue; }
//
//    String    matchStr = "colName:"+colName+"whereColumn:"+whereColumn+"whereMatch:"+whereMatch;
//    PJ_TagPtr    tag;
...
//}
//
//float SQLTable::CachedFloatValue(String& colName, String& whereColumn, String& whereMatch, float defaultValue) {
//    if (NULL == db) { return defaultValue; }
//
//    String    matchStr = "colName:"+colName+"whereColumn:"+whereColumn+"whereMatch:"+whereMatch;
//    PJ_TagPtr    tag;
...
//    }
//
//    float    result = FloatValue(colName, whereColumn, whereMatch, defaultValue);
//    db->cache->SetFloatValue(matchStr, result);
//    return result;
//
//}
//
//String SQLTable::CachedStringValue(String& colName, String& whereColumn, String& whereMatch, String& defaultValue) {
//    if (NULL == db) { return defaultValue; }
//
//    String    matchStr = "colName:"+colName+"whereColumn:"+whereColumn+"whereMatch:"+whereMatch;
//    PJ_TagPtr    tag;
...
//    }
//
//    String    result = StringValue(colName, whereColumn, whereMatch, defaultValue);
//    db->cache->SetStringValue(matchStr, result);
//    return result;
//
//}
//
...
//            }
//            if (columnCount > 0) {
//                String    cell((const char*)sqlite3_column_text(statement, 0));
...
//}
//
//void SQLTable::SelectStrColWhere(String& colName, String& whereColumn, String& whereMatch, vector<String>& cells) {
//
//    cells.clear();
//
//    String    cmd = "select ";
...
//}
//
//void SQLTable::SelectStrColWhereSet(String& colName, String& whereColumn, String& whereMatch, set<String>& cells) {
//
//    cells.clear();
//
//    String    cmd = "select ";
...
//bool SQLTable::LoadFileBlob(String& colName, String& whereColumn, String& whereMatch, String& path, bool addToTable)
//{
//    FileManager *fm = FileManager::GetInstance();
...
//                sqlite3_bind_blob(statement, 1, data->GetData(), static_cast<int>(data->GetDataSize()), NULL);
//
...
//            return LoadFileBlob(colName, whereColumn, whereMatch, path, false);
//        }
//
...
//
//    CAREFUL:
//    SELECT "column_name" from table_name where x=y produces a strange result. It returns the actual string "column_name", which doesn't make sense.
//    SELECT [column_name] produces the correct results, but this isn't standard SQL?
//
...
//
// */
//bool SQLTable::WriteBlobToFile(String& colName, String& whereColumn, String& whereMatch, String& path, bool writeEmpty)
//{
//    bool    result = false;
//
...
//                    sqlite3_finalize(statement);    // FUTURE: use PJ_SQLPrepareStatement to prevent accidental failure to finalize.
//                    return false;
//                }
//
//                PJ_FilePtr    file = PJ_File::NewFilePtr();
...
//
//
//void SQLTable::InsertInto(PJ_StringList const& names, PJ_StringList const& values) {
//#ifdef __DEBUG__
//    if (names.size() > values.size()) {
//        PJLog("WARNING. InsertInto. Names size %lu doesn't match Values size %lu", names.size(), values.size());
//    }
//#endif
//
//    String cmd;

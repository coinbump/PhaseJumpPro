...
//}
//
//void FileManager::CollectDirSubPaths(String path, PJ_TStdVector<String>& subPaths)
//{
...
//}
//
//void FileManager::MapSubpath(Path pathType, PathDomain domain, String subpath) {
...
//}
//
//String FileManager::GetPath(PJ_ConstStr &_path, Path pathType, PathDomain domain) {
//
//    FileManager* fm = FileManager::GetInstance();
//    String path = _path;
//
...
//{
//    return this->GetPath(path, FileManager::Path::PathApp, FileManager::PathDomain::Default);
//
//}
//
//String FileManager::ApplicationDataPath(String path, FileManager::PathDomain domain)
//{
...
//    return this->GetPath(path, FileManager::Path::PathTemp, FileManager::PathDomain::Default);
////}
//
//bool FileManager::IsImageFileType(String fileType) {
//    return (fileType.CompareNoCase("jpg") || fileType.CompareNoCase("png") || fileType.CompareNoCase("jpeg"));
//}
//
...
//    InspectContentType
//
//    Supports the file type being embedded inside the file instead of via extension.
//
//    CURRENTLY SUPPORTS:
//    1. XML tag: <file_type>, first line of file (no encoding information/UTF-XXX).
//
// */
...
//}
//
//String FileManager::StripPathSuffix(String path, char extendChar, bool stripExtendChar)
//{
//    String result = path;
//

...
//{
//    if (NULL == schema.get()) {
//        PJ::Log("ERROR. Can't BuildTable with NULL schema");
//        return false;
//    }
//
//    bool    result = false;
...
//                                 PJ::Log("UNSUPPORTED. Can't convert data blogs
...
//         PJ::Log("ERROR. LoadFileBlob couldn't find file %s", path.c_str());
//         return false;
//     }
//
//     bool result = false;
...
////                    PJ::Log("SQL. Didn't write empty blob.");
...
//        PJ::Log("WARNING. InsertInto. Names size %lu doesn't match Values size
...
////        PJ::Log("Multiple insert %s", cmd.c_str());
//    }
//    else {

...
namespace PJ
{
    ...
    class ExpView2D : public Node2D, public SomePointerEventsResponder
    {
    protected:
        Rect frame;
...
//
    ...
    public:
        bool NeedsLayout() const { return needsLayout; }
...
//        }
//
//        protected virtual std::optional<Vector2> SpriteRendererSize(SpriteRenderer spriteRenderer)
//        {
//            switch (spriteRenderer.drawMode)
//            {
//                case SpriteDrawMode.Sliced:
...
//        }
//
//        std::optional<float> IntrinsicHeightFor(SpriteRenderer spriteRenderer)
//        {
//            var scale = spriteRenderer.gameObject.transform.localScale;
//
//            switch (spriteRenderer.drawMode)
...
//        }
//
//        SP<SomeCamera> Camera() const { return camera ? camera : Camera::main; }

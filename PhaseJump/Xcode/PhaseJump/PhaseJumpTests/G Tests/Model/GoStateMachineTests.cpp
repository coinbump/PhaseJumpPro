...
namespace GoStateMachineTests {
    ...
    class TestStateMachine : public GoStateMachine<TestEnum>
    {
    public:
        using Base = GoStateMachine<TestEnum>;
...
using namespace GoStateMachineTests;

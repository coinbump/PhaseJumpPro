...
namespace PJ
{
    ...
    /// </summary>
    public abstract partial class SomeAnimatedStateEffect<StateType, ValueType> : SomeStateHandler<StateType>
    {
        /// <summary>
        ...
        protected PJ.Timer transitionTimer;
        ...
        public override void OnStateChange(StateType state)
        {
            ...
            transitionTimer = new PJ.Timer(duration, SomeRunner.RunType.RunOnce);
    ...
    // public abstract partial class SomeTransformAnimatedStateEffect<StateType> : SomeAnimatedStateEffect<StateType, GeoTransform>
    // {

...
namespace PJ
{
    ...
    /// <summary>
    /// Standard property names for encoding, or for in-memory custom properties
    /// </summary>
    /// 
    /// Code style:
    ...
    public abstract class TagNames
    {
        ...
        public const string DescriptionShort = "desc_short";        // Short description.
        ...
        public const string Label = "label";            // Label (esp graphs). Concat for lots of nodes.
        public const string DrawableName = "draw_name";     // Name of the drawable to represent an entity visually

...
/// </summary>
public class EMREnemy : MatrixNode2D
{
    protected class MoveTimer : Timer
    {
        WeakReference<EMREnemy> owner;

        public MoveTimer(EMREnemy owner) : base(3.0f, SomeRunner.RunType.KeepRunning)
        {
            this.owner = new WeakReference<EMREnemy>(owner);
        }
        ...
        protected override void OnFinish()
        {
            ...
            if (owner.TryGetTarget(out EMREnemy enemy))
            {

...
//			{
//				PathMover node = target.GetComponent<PathMover>();
//				if (null != node)
//				{
...
//		public override void SnapNodeToPath(PathMover node, bool force = false)
//		{
...
//		public override void UpdateNodeOnPath(PathMover node)
//		{
//			var positions = this.GetWaypointPositions2D();

//			PathMover.PathInfo pathInfo = node.pathInfo;
...
//		protected void GetPathPositions(PathMover node, out Vector2 positionStart, out Vector2 positionEnd)
//		{
//			int origin = node.pathInfo.waypointOrigin;
//			var positions = GetWaypointPositions2D();

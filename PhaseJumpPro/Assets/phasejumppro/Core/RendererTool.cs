...
namespace PJ
{
    ...
    public class RendererTool
    {
        ...
        public RendererTool(GameObject gameObject)
        {
        ...
        public Optional<Vector3> WorldSize
        {
            get
            {
                if (spriteRenderer)
                {
                    return new(new(spriteRenderer.size.x, spriteRenderer.size.y, 0));
                }
        ...
        public float Alpha
        {
            ...
            set
            {
                Color = new Color32(Color.r, Color.g, Color.b, (byte)(value * 255.0f));
            }
        }
    }
}

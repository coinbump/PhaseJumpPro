...
namespace PJ
{
    public class UnitTests_AcyclicGraphNode
    {
        ...
        public void Test_RootNode()
        {
            ...
            Assert.AreEqual(node, node.Root);
            Assert.AreEqual(node, childNode1.Root);
            Assert.AreEqual(node, childNode2.Root);
            Assert.AreEqual(node, deepNode.Root);
        }
        ...
        public void Test_RootNodeCircular()
        {
            ...
            Assert.AreEqual(null, node.Root);
            Assert.AreEqual(null, childNode2.Root);
            Assert.AreEqual(null, childNode1.Root);
            Assert.AreEqual(null, deepNode.Root);
        }

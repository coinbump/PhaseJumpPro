...
namespace PJ
{
    public class UnitTests_PlaneMesh
    {
        ...
        public void Test1x1PlaneMesh()
        {
            ...
            Assert.AreEqual(new Vector3(-1.0f, 0, 1.0f * Vector2.up.y), vertices[0]);
            Assert.AreEqual(new Vector3(1.0f, 0, 1.0f * Vector2.up.y), vertices[1]);
            Assert.AreEqual(new Vector3(-1.0f, 0, 1.0f * Vector2.down.y), vertices[2]);
            Assert.AreEqual(new Vector3(1.0f, 0, 1.0f * Vector2.down.y), vertices[3]);
        }
        ...
        public void Test2x1PlaneMesh()
        {
            ...
            Assert.AreEqual(new Vector3(-1.0f, 0, 1.0f * Vector2.up.y), vertices[0]);
            Assert.AreEqual(new Vector3(0f, 0, 1.0f * Vector2.up.y), vertices[1]);
            Assert.AreEqual(new Vector3(1.0f, 0, 1.0f * Vector2.up.y), vertices[2]);
            Assert.AreEqual(new Vector3(-1.0f, 0, 1.0f * Vector2.down.y), vertices[3]);
            Assert.AreEqual(new Vector3(0, 0, 1.0f * Vector2.down.y), vertices[4]);
            Assert.AreEqual(new Vector3(1.0f, 0, 1.0f * Vector2.down.y), vertices[5]);
        }
        ...
        public void Test1x2PlaneMesh()
        {
            ...
            Assert.AreEqual(new Vector3(-1.0f, 0, 1.0f * Vector2.down.y), vertices[4]);
            Assert.AreEqual(new Vector3(1.0f, 0, 1.0f * Vector2.down.y), vertices[5]);
        }
    }
}

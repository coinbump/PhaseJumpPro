...
namespace PJ
{
    ...
    /// </summary>
    public class StageEntity : WorldComponent
    {
        ...
        protected class SlideValve : Valve
        {
            ...
            public SlideValve(StageEntity owner, float enterExitTime)
            {
                ...
                turnOffTimer = new TransformTimer(enterExitTime, SomeRunner.RunType.RunOnce, new EaseOutSquared());
                turnOnTimer = new TransformTimer(enterExitTime, SomeRunner.RunType.RunOnce, new EaseOutSquared());
            }
